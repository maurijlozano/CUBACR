...
fn<-paste(args[1],"freqs4.tree",sep='')
...
names[1:4,2]<-paste(names[1:4,2],"-Nc: ",NCHL[c(4,5,10,11),2],sep="")
names[grep('[Ss]ingle',names[,2]),2]<-"Single"

tree$tip.label<-names[[2]][match(tree$tip.label, names[[1]])]

fn<-paste(args[1],"tree.control2.svg",sep='')
